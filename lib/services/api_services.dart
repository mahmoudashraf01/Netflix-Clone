...
class ApiServices {
  ...
  Future<SearchModel> getSearchedMovie(String searchText) async {
    ...
    final response = await http.get(Uri.parse(url), headers: {
      'Authorization':
          'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0YTAzNjcwOTYwZGY0Njk4MGM5ZGNiZTUxZmM0NzNmYyIsIm5iZiI6MTcyMTkzMDk3Ni4xNjIzNDQsInN1YiI6IjY2YTI4ZTdjZmRiNTIyYTM1NDVkMzcyZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.AOgyELyDoTmDotLuMETowbDmb2UsXVRWDy2oUFGK-0M'
    });
